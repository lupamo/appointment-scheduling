...
- Webhook is unauthenticated (/mpesa/callback) — anyone who knows the URL can forge a 'payment succeeded'. IP-allowlist Safaricom or verify via query_stk_status before trusting it.
